...
export const SizableColumnList: FC<IProps> = ({ value, onChange, readOnly }) => {
  ...
  const handleSave = (row: ISizableColumnProps) => {
  ...
  const tableColumns: any[] = [
    ...
    },
    {
      title: 'Action',
      dataIndex: 'operation',
      render: (_: any, record: ISizableColumnProps) =>
        columns.length >= 1 ? (
    ...
    return {
      ...col,
      onCell: (record: ISizableColumnProps) => ({
        record,
...
export default SizableColumnList;
